...
#  message(STATUS "  (dbg) ${CPACK_DEBIAN_PACKAGE_SOURCE_COPY} ${CMAKE_SOURCE_DIR} ${DEBIAN_SOURCE_ORIG_DIR}.orig")
  execute_process(COMMAND ${CPACK_DEBIAN_PACKAGE_SOURCE_COPY} "${CMAKE_SOURCE_DIR}/" "${DEBIAN_SOURCE_ORIG_DIR}.orig")
else()
#  message(STATUS "  (dbg) ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR} ${DEBIAN_SOURCE_ORIG_DIR}.orig")
...
foreach(RELEASE ${CPACK_DEBIAN_DISTRIBUTION_RELEASES})
  ...
  set(RELEASE_PACKAGE_VERSION "${CPACK_PACKAGE_VERSION}-${CPACK_DEBIAN_DISTRIBUTION_NAME}1ppa${CPACK_DEBIAN_PPA_UPLOAD_REVISION}~${RELEASE}1")
  ...
  file(WRITE ${DEBIAN_CONTROL}
    ...
    "XSBC-Original-Maintainer: ${CPACK_ORIG_PACKAGE_CONTACT}\n"
    "Build-Depends: "
    )
